// Spitfire Mk XIVe 2x 20mm, 2x cal50, bombs

main:
	
	self.name = "Supermarine Spitfire Mk XIVe"
	self.role = "Fighter"
	self.team = allies
	self.flightmodel = "spitfireXIV"
	...
	waitthread global/skylimit/plane_selection.scr::addloadout bomb_250kg bomb_250kg_europe pylon0
