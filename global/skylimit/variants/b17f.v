// B17F Heavy Bomber, 12x250kg interal

main:
	
	self.name = "Boeing B-17F Flying Fortress"
	self.role = "Strategic Bomber"
	self.team = allies
	self.flightmodel = "B17F"
	self.modelid = "b17"
	...
	waitthread global/skylimit/plane_selection.scr::addinventory bomb_250kg_internal 12
